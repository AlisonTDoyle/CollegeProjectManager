...
namespace CollegeProjectManager.Pages
{
    ...
    public partial class ProjectDetails : Page
    {
        ...
        private void DeleteProject()
        {
            ...
            if(System.Windows.Forms.MessageBox.Show("Are you sure you want to delete this project? This action is ireverable", "Error", (MessageBoxButtons)MessageBoxButton.YesNoCancel) == DialogResult.Yes)
            {
